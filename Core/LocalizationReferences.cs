    ...
    public static class Mods
    {
        ...
        public static class Cataphract
        {
            ...
            public static class Projectiles
            {
                ...
                public static class RockSceptor_Explosion
                {
                    public const string KEY = "Mods.Cataphract.Projectiles.RockSceptor_Explosion";
                    ...
                    public static class DisplayName
                    {
                        public const string KEY = "Mods.Cataphract.Projectiles.RockSceptor_Explosion.DisplayName";
                        public const int ARG_COUNT = 0;
            ...
            {
                public const string KEY = "Mods.Cataphract.NPCs";
                ...
                public static class MagicScientist
                {
                    public const string KEY = "Mods.Cataphract.NPCs.MagicScientist";
                    ...
                    public static class DisplayName
                    {
                        public const string KEY = "Mods.Cataphract.NPCs.MagicScientist.DisplayName";
                        public const int ARG_COUNT = 0;
